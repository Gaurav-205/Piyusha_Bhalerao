...
interface SmoothCursorProps {
  ...
  springConfig?: typeof CURSOR_SPRING_CONFIG;
}

const DefaultCursorSVG = memo(() => (
  <svg
...
export const SmoothCursor = memo(({
  ...
  const scaleTimeout = useRef<NodeJS.Timeout | undefined>(undefined);
    ...
    rafId.current = requestAnimationFrame(() => {
      ...
      if (speed > 0.1) {
        ...
        scaleTimeout.current = setTimeout(() => {
          scale.set(1);
        }, ANIMATION_DURATIONS.CURSOR_SCALE);
      }
